...
export const propertyDetailResponsePromptTemplate =
  ChatPromptTemplate.fromMessages([
    [
      ...
      <매물 데이터 정보>
      - 매물 데이터는 순위별(1등, 2등, …)로 정렬된 배열로 최대 3개의 데이터가 주어집니다.
      ...
      - (중요!) Markdown 문법을 절대 사용하지 마세요. ex) **주소** 와 같이 작성하지 마세요.

      ---
      <응답 규칙>
      (중요!) 모든 응답은 반드시 순수한 일반 텍스트(plain text)로 작성하며, Bold나 Italic, 코드 블록 등 Markdown 문법을 절대 사용하지 마세요.
    ...
    ['human', `Previous messages: {history}, Current message: {current}`],
  ]);
